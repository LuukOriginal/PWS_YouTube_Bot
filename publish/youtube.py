...
CLIENT_SECRETS_FILE = "video_generation/client_secret.json"
MAX_RETRIES = 10
...
def publish(video: Video) -> None:
    ...
    storage = Storage("video_generation/credentials.storage")
    credentials = storage.get()

    if credentials is None or credentials.invalid:
        print("Credentials invalid..., prompting to login...")
